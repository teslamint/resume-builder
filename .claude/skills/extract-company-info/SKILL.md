...
```bash
python -m templates.jd.company_validator --file private/company_info/{company_slug}.md --fix
```

자동화/스크립트 연동 시 JSON 출력 사용:

```bash
python -m templates.jd.company_validator --file private/company_info/{company_slug}.md --json
```
