...
```
채용공고: private/job_postings/{id}-{company}-{position}.md
기업정보: private/company_info/{company_slug}.md
```

## 출력 포맷

### 기업 정보 (private/company_info/*.md)
...
5. private/job_postings/{id}.md + private/company_info/{company}.md 저장
```
