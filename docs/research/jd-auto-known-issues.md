...
- **Status**: **Resolved 2026-04-28** (PR: fix/jd-pipeline-pr1-mtime-jdpath)
...
- **Status**: **Resolved 2026-04-28** (PR: fix/jd-pipeline-pr2-find-jd-anywhere)
- **Location**: `templates/jd/path_utils.py:97-121` (`find_existing_jd`), `templates/jd/auto.py:175-179` (`_resolve_jd_path_for_screening`)
...
- **Status**: **Resolved 2026-04-28** (PR: fix/jd-pipeline-pr1-mtime-jdpath)
- **Location**: `templates/jd/auto.py` (classification block)
...
- **Applied partial fix** (this PR): `--disable-blink-features=AutomationControlled` added to `company_extractor.py` Chromium launch args. No effect on Saramin's gate.
